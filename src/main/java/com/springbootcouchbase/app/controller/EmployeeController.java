...
public class EmployeeController {
	...
	/*This method creates a new employee and adds to the bucket 'employee' through http post method */
	...
	/*This method returns the employee details based on first name*/
	...
	/*this method returns the employee details based on employee ID*/
